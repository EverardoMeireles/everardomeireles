...
export function IndexMenu(props) {
    ...
    return(
    <>
        <mesh onClick= {() => setPath("projects")} /*? setClicked(true) : setClicked(false)*/><BaseCube position={[0,0,0]} /></mesh>
