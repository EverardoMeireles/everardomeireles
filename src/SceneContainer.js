...
if(window.innerWidth < 500){
    ...
    fadingTextPosition4 = ResponsiveTable["Widescreen"]["fadingTextPosition3"]
    fadingTextScale4 = ResponsiveTable["Widescreen"]["fadingTextScale3"]
    fadingTextText5 = ResponsiveTable["Widescreen"]["fadingTextText3"]
    fadingTextPosition5 = ResponsiveTable["Widescreen"]["fadingTextPosition3"]
    fadingTextScale5 = ResponsiveTable["Widescreen"]["fadingTextScale3"]
    ...
    return(
        <>
            ...
            <Suspense fallback = {null} >
                ...
                <FadingText {...{useStore}} textToFade={TranslationTable[currentLanguage][fadingTextText0]} lettersPerUnit = {5} textModelMenu="ProfessionalExpProjects0" scale={fadingTextScale0} initialPosition={fadingTextPosition0} rotation={2 * Math.PI} visible={false} textColor={"#FFFFFF"} manualLineBreaks={true} />
                <FadingText {...{useStore}} textToFade={TranslationTable[currentLanguage][fadingTextText1]} textModelMenu="ProfessionalExpProjects1" scale={fadingTextScale1} initialPosition={fadingTextPosition1} rotation={Math.PI/2} visible={false} textColor={"#FFFFFF"} manualLineBreaks={true} />
                <FadingText {...{useStore}} textToFade={TranslationTable[currentLanguage][fadingTextText2]} textModelMenu="ProfessionalExpProjects2" scale={fadingTextScale2} initialPosition={fadingTextPosition2} rotation={Math.PI} visible={false} textColor={"#FFFFFF"} manualLineBreaks={true} />
                <FadingText {...{useStore}} textToFade={TranslationTable[currentLanguage][fadingTextText3]} textModelMenu="ProfessionalExpProjects3" lettersPerUnit={10} scale={fadingTextScale3} initialPosition={fadingTextPosition3} rotation={3*(Math.PI/2)} visible={false} textColor={"#FFFFFF"} manualLineBreaks={true} />
                <FadingText {...{useStore}} textToFade={TranslationTable[currentLanguage][fadingTextText4]} textModelMenu="ProfessionalExpProjects4" lettersPerUnit={9} scale={fadingTextScale4} initialPosition={fadingTextPosition4} rotation={2 * Math.PI} visible={false} textColor={"#FFFFFF"} manualLineBreaks={true} />
                <FadingText {...{useStore}} textToFade={TranslationTable[currentLanguage][fadingTextText5]} textModelMenu="ProfessionalExpProjects5" scale={fadingTextScale5} lettersPerUnit={7} initialPosition={fadingTextPosition5} rotation={Math.PI/2} visible={false} textColor={"#FFFFFF"} manualLineBreaks={true} />
